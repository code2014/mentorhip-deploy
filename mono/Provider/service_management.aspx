<%@ Page Title="Home" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="service_management.aspx.cs" Inherits="mono.service_management" %>
                                ...
                                <h5>PERSONAL INFORMATION</h5>
                                    ...
                                    <div class="control-group">
                                       ...
                                       <label class="control-label">Description</label>
                                        <div class="controls">
                                            <asp:TextBox ID="TextBox1" runat="server" TextMode="MultiLine" Height="100px" Width="90%"></asp:TextBox>
                                        </div>
                                    <div class="controls">
                         ...
                         <div class="span6">
                                ...
                                <h5>CHANGE PASSWORD</h5>
                                      <label class="control-label" for="input">Old Password</label>
                                       ...
                                       <div class="controls">
                                        <asp:Button ID="Button2" runat="server" Text="Confirm" CssClass="btn block"   />
                                    </div>
                              </div>
                         </div>
                          <div class="span6">
                                ...
                                <h5>UPLOAD A LOGO</h5>
                                    ...
                                    <div class="controls">
                                        ...
                                        <asp:Button ID="Button3" runat="server" Text="Upload" CssClass="btn block" />
                                    </div>
                              </div>
                         </div>
