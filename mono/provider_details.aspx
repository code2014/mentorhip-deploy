            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                        <div id="gallery" class="span4">
                            <a href="assets/img/provider/gma.jpg" >
                                <img src="assets/img/provider/gma.jpg" style="width:100%" />
                            </a>
                           <!-- <div id="differentview" class="moreOptopm carousel slide">
                                <div class="carousel-inner">
                                  <div class="item active">
                                   <a href="assets/img/provider/gma.jpg"> <img style="width:29%" src="assets/img/provider/gma.jpg" alt=""/></a>
                                   <a href="assets/img/provider/gma.jpg"> <img style="width:29%" src="assets/img/provider/gma.jpg" alt=""/></a>
                                   <a href="assets/img/provider/gma.jpg" > <img style="width:29%" src="assets/img/provider/gma.jpg" alt=""/></a>
                                  </div>
                                  <div class="item">
                        ...
                        <div class="span8 pull-left">
                            ...
                            <div class="tab-content tab-fixHeight">
                                ...
                                <div class="tab-pane fade active in" id="discription">
                                    <p>
                                        Championship Martial Arts provides an environment that enriches all aspects of human development – mind, body, and spirit. 
                                        Our programs were developed to invigorate the body, strengthen character, heighten personal energy, focus the mind, and unify our membership into a community. 
                                        We have tailored our programs to be accessible to all age groups and all levels of experience. We offer new challenges to the seasoned veteran and inspiration for the novice. 
                                        We offer individual training opportunities as well as group classes. 
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table table-striped" style="margin-bottom: 0;">
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-small btn-block" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne">Details</a>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                              ...
                              <div class="accordion-heading">
                                <table class="table table-striped" style="margin-bottom: 0;">
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            <a class="btn btn-success btn-small btn-block" href="#">$360</a>
                                            <a class="btn btn-small btn-block" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo">Details</a>
                                        </td>
                                    </tr>
                                </table>
                              </div>
                              ...
                              <div class="accordion-heading">
                                <table class="table table-striped" style="margin-bottom: 0;">
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            <a class="btn btn-success btn-small btn-block" href="#">$360</a>
                                            <a class="btn btn-small btn-block" data-toggle="collapse" data-parent="#accordion2" href="#collapseThree">Details</a>
                                        </td>
                                    </tr>
                                </table>
                              </div>
                              ...
                              <div class="accordion-heading">
                                 <table class="table table-striped" style="margin-bottom: 0;">
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            <a class="btn btn-success btn-small btn-block" href="#">$360</a>
                                            <a class="btn btn-small btn-block" data-toggle="collapse" data-parent="#accordion2" href="#collapseFour">Details</a>
                                        </td>
                                    </tr>
                                </table>
                              </div>
                              ...
                              <div class="accordion-heading">
                                <table class="table table-striped" style="margin-bottom: 0;">
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            <a class="btn btn-success btn-small btn-block" href="#">$360</a>
                                            <a class="btn btn-small btn-block" data-toggle="collapse" data-parent="#accordion2" href="#collapseFive">Details</a>
                                        </td>
                                    </tr>
                                </table>
                              </div>
                              ...
                              <div class="accordion-heading">
                                <table class="table table-striped" style="margin-bottom: 0;">
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            <a class="btn btn-success btn-small btn-block" href="#">$360</a>
                                            <a class="btn btn-small btn-block" data-toggle="collapse" data-parent="#accordion2" href="#collapseSix">Details</a>
                                        </td>
                                    </tr>
                                </table>
                              </div>
