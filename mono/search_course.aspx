<%@ Page Title="Home" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="search_course.aspx.cs" Inherits="mono.search_result_course" %>
        ...
        <div class="container">
            <div class="container-fluid">
                <div class="span2 pull-left well">
                    ...
                    <form class="form-inline">
                      <lable class="control-label">Distance from location</lable>
                ...
                <div class="span8 pull-left">
                    <div class="row">
                      <div class="span4"><h4>Search results for "Soccer":</h4></div>
                    ...
                    <div class="row">
                        <div class="span2 ">
                            ...
                            <div class="pagination-centered">
                                <a href="course_info.aspx"><h7>Soccer Beginner</h7></a>
                    ...
                    <div class="row">
                        <div class="span2 ">
                            ...
                            <div class="pagination-centered">
                                <a href="course_info.aspx"><h7>Soccer Advanced</h7></a>
                                <a class="btn btn-success btn-small btn-block" href="#">stars!!!</a>
                            </div>
                            <p class="small"><font size="1" face="verdana" >
                            The purpose of the club is to provide an environment where young athletes can engage in healthy soccer competition...
