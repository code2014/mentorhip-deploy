                        ...
                        <div class="span10">
                            ...
                            <div style="height:auto">
                                ...
                                <div class="tab-content courseTabFixHeight">
                                    <div class="tab-pane fade active in" id="photo" style="width:90%">
                                    ...
                                    <div class="tab-pane fade" id="map" style="width:90%">
                                        <div class="span7">
                                    ...
                                    <div class="tab-pane fade" id="Ratings" style="width:90%">
                                        ...
                                        <table>
                                            <tr>
                                                <td class="UserReviewPhoto">
                                                    <img src="assets/images/products/large/f1.jpg" alt="" />
                                                </td>
                                                <td>
                                                    <p>
                    ...
                    <div class="span4">
                        ...
                        <div class="expandable-layer1">
                            ...
                            <div class="expandable-content1">
                                <div class="pagination-centered">
                                    <img src="assets/images/provider/gma.jpg" width="100" height="100" />
                                </div>
                                <p class="pagination-left">
                                    <font size="2" face="verdana">
											Northbrook Park District Martial Arts provides an environment that enriches all aspects of human development – mind, body, and spirit. Our programs were developed to invigorate the body, strengthen character, heighten personal energy, focus the mind, and unify our membership into a community. We have tailored our programs to be accessible to all age groups and all levels of experience. We offer new challenges to the seasoned veteran and inspiration for the novice. We offer individual training opportunities as well as group classes.
					</font>
                                </p>
                            </div>
                        </div>
                        <div class="expandable-layer1">
                            ...
                            <div class="expandable-content12b">
                                ...
                                <hr class="soft clr" />
                                <h4>Contact</h4>
                                <font size="2"><p>	2735 Pfingsten Rd, Glenview, IL 60026</p>
	<p>(847) 564-5425</p>
	<a href="http://www.glenviewmartialarts.com">http://www.glenviewmartialarts.com</a></font>
                            ...
                            <div class="expandable-content2b">
                                <table class="table">
                                    <tr>
                                        <td>
                                            <img src="assets/images/class/3.jpg" width="70" height="70" />
                            ...
                            <td>$30/class
										      ...
										      <tr>
                                                  <td>
                                                      <img src="assets/images/class/4.jpg" width="70" height="70" />
                       </td>
										     <td>
